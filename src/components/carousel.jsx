...
[
  {
    src: 'https://res.cloudinary.com/chris-kubick/image/upload/v1597701935/pendulum_hitwxw.jpg',
    altText: 'Slide 1',
    caption: 'Slide 1'
  },
  {
    src: 'https://res.cloudinary.com/chris-kubick/image/upload/v1596875597/screenshot-61-1596563879_lrldp1.png',
    altText: 'Slide 2',
    caption: 'Slide 2'
  },
  {
    src: 'https://res.cloudinary.com/chris-kubick/image/upload/v1596065032/sample.jpg',
    altText: 'Slide 3',
    caption: 'Slide 3'
  }
],
        ...
        const slides = itemsArray[itemsIndex].map((item) => {
          ...
          return (
            ...
            <div className='buttons-container'>
              <Button className="button-item" onClick={() => this.changeIndex(0)}>1</Button>
              <Button className="button-item" onClick={() => this.changeIndex(1)}>2</Button>
              <Button className="button-item" onClick={() => this.changeIndex(2)}>3</Button>
            </div>
